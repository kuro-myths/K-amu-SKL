    ...
    <div class="w-full max-w-md">
        <div class="glass rounded-3xl p-8 shadow-lg">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm mt-2">Bergabung gratis di K-amu SKL</p>
            </div>
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm"><span class="px-3 bg-white text-gray-400">atau daftar dengan email</span></div>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" required
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-400 focus:ring-2 focus:ring-purple-100 outline-none transition">
                </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-purple-600 font-semibold hover:text-purple-700">Masuk</a>
            </p>
        </div>
    </div>
</div>
