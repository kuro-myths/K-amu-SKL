...
<section class="py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 class="text-lg font-bold text-gray-900 mb-4">Tautan Terakhir Kamu</h2>
            @forelse($recentEducations as $edu)
                <div class="flex items-center justify-between py-3 border-b border-gray-50 last:border-0">
                    ...
                    <div class="flex items-center gap-2 ml-4">
                        ...
                        <form action="{{ route('education.destroy', $edu) }}" method="POST" onsubmit="return confirm('Hapus tautan ini?')">
                            @csrf @method('DELETE')
            ...
            @empty
                <p class="text-gray-400 text-center py-6">Belum ada tautan. <a href="{{ route('submit') }}" class="text-purple-600 font-semibold">Kirim sekarang!</a></p>
            @endforelse
        </div>
    </div>
</section>
