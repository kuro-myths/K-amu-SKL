    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="GET" action="{{ route('explore') }}" class="glass rounded-2xl p-6 mb-8">
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <select name="level" class="px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-400 outline-none">
                    ...
                    <option value="basic" {{ request('level') == 'basic' ? 'selected' : '' }}>Dasar</option>
                    ...
                    <option value="free" {{ request('level') == 'free' ? 'selected' : '' }}>Gratis</option>
                </select>
        ...
        @if($educations->isEmpty())
            <div class="text-center py-20">
                ...
                <a href="{{ route('explore') }}" class="text-purple-600 font-semibold mt-2 inline-block">Atur ulang filter</a>
            </div>
        @else
