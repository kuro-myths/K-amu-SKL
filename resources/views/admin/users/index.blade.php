...
<section class="py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-8">Kelola User</h1>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right">
                                <form action="{{ route('admin.users.toggle-role', $user) }}" method="POST" class="inline mr-2">
                                    @csrf @method('PATCH')
                                    <button class="text-purple-600 hover:text-purple-700 text-sm font-medium">Toggle Role</button>
                                </form>
                                @if($user->id !== Auth::id())
